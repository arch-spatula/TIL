...
- 영 쉘든을 모두 봤습니다. 시즌 7개를 다 볼 것이라고 생각하지는 못했습니다.

### Learned

- 마감이 있는 것은 어느정도 도움되었습니다. 하지만 처음 생각과 달라진 부분에 대해서 그만큼 마감을 늘려야 할지 다른 기능을 개발할지 고민을 더 해야 합니다.

### Lacked

- 이번주는 어려운 선택을 많이 못했습니다.
  - 그냥 퇴근하고 유튜브나 넷플릭스를 안 보면 되는 것입니다. 그냥 침묵에 익숙해지면 되는 것인데 자취하면서 새롭게 생긴 습관 같습니다.

### Longed(잘하기 위해 필요한 것)

- 절제력이 필요합니다. 1개의 에피소드 정도 보는 루틴이 있는데 이제 이 루틴을 제거해야 합니다.
- 그냥 유튜브, 넷플릭스만 안 키면 되는 문제입니다. 돌아왔을 때 루틴에 더 주의를 기울려야 합니다.
...
- 플래시카드
  ...
  - [ ] nav 스크롤 없이 항상 보이도록 수정
    - CSS 만 고쳐도 됩니다.
    - 목표 기한: 2025.02.20.
  - [ ] 필터를 저장 시점에 적용 되도록 디버깅
    - 목표 기한: 2025.02.22.
    - 정확히 버그라는 점은 유저가 평소 경험하는 것과 다르다는 점에서 버그입니다.
- 정보처리기사
  - 재시도하기
  - [ ] 접수 하기: 2025.03.24. 
  - [ ] 시험 보기: 2025.04.20.
