...
- [ ] 정보처리기사 1회독(6 / 121 = 4.95%, 약 88일 남음)
- [ ] 요구사항 분석(5)
  - [ ] 분석 모델 확인하기(5)
    - [ ] 분석(참고) 모델
    - [ ] 객체지향 분석 모델
...
https://www.youtube.com/watch?v=JH_BGlS5LR4
...
- 시나공 수험서를 탈출했습니다.
  - 코드 작성 경험이 없는 강사의 코드를 보는 것오 ㅂㄷㅂㄷ 했습니다. 이제 이런 코드를 더이상 안볼 수 있습니다.
  - 합을 나타내는 변수명을 `sum`이라고 안하고 `hap`이라고 명명하는 책을 더이상 안봐도 되서 너무 좋습니다.

### Learned

- node_modules 내에서 logging 하는 방법을 익혔습니다.

### Lacked

- 주말에 정처기 실기 수험서를 안 챙겼습니다.
  - 그래서 본가로 내려와서 공부를 안 했습니다. 정확히 할 수 없었습니다.

### Longed(잘하기 위해 필요한 것)

- 정보처리기사 실기 준비해야 합니다. 주말 중에 아무것도 공부하지 못했습니다.
